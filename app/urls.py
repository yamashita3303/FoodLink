...
urlpatterns = [
    ...
    path('search/', views.user_search, name='user_search'),  # 検索ペー
    path('store/<int:store_id>/', views.store_product_list, name='store_product_list'),# 店舗の商品一覧ページ
    ...
    path('store_notification_done/<int:notification_id>/', views.store_notification_done, name='store_notification_done'),
